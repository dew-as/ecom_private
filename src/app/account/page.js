...
export default function Account() {
  ...
  async function handleAddOrUpdateAdddress() {
        ...
        <div className="bg-white shadow">
          <div className="p-6 sm:p-12">
            ...
            <div className="flex flex-col flex-1">
              ...
              <p className="text-sm text-center md:text-left">{user?.role}</p>
            </div>
            <button
              onClick={() => router.push("/orders")}
              className="mt-3 inline-block bg-black text-white px-5 py-3 text-xs font-medium uppercase tracking-wide"
            >
              View Your Orders
            </button>
            <div className="mt-5">
                    ...
                    addresses.map((item) => (
                      <div className="border p-6" key={item._id}>
                        ...
                        <button
                          ...
                          className="mt-3 inline-block bg-black text-white px-4 py-2 text-xs font-medium uppercase tracking-wide"
                        >
                          {componentLevelLoader &&
            ...
            {showAddressForm ? (
              <div className="flex flex-col mt-5 justify-cenrer pt-4 items-center">
                ...
                <button
                  onClick={handleAddOrUpdateAdddress}
                  className="mt-3 inline-block bg-black text-white px-5 py-3 text-xs font-medium uppercase tracking-wide"
                >
